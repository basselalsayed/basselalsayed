...
| :------ | :------------- | :------ | :-----|
|  [Algorithm-Visualiser](https://github.com/Walker-TW/Algorithm-Visualizer) | Built purely in react, this app enacts different route finding algorithms in a visual representastion. Great learning opportuntity for making a program as easy as possible for the user. Was a nice opportunity to try hooks. Built with TDD. | 3 weeks | React.js
